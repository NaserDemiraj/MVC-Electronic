      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">Sign up to get started with CircuitCraft</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-violet-100">
